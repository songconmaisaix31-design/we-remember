...
A dependency-free prototype for a conversation-first family schedule. It supports a public family-key fixture, unique family matching, preset or locally uploaded avatars, typed Agent messages, browser live dictation, auto-send voice messages, confirmation-gated scheduling, local notification receipts, and an optional multi-platform connection center.
